...
class PredictionsControllerTest < ActionController::TestCase
  ...
  test "should create prediction" do
    assert_difference('Prediction.count') do
      post :create, prediction: { pdate: @prediction.pdate, prediction: @prediction.prediction, time: @prediction.time, user: @prediction.user }
    end
  ...
  test "should update prediction" do
    patch :update, id: @prediction, prediction: { pdate: @prediction.pdate, prediction: @prediction.prediction, time: @prediction.time, user: @prediction.user }
    assert_redirected_to prediction_path(assigns(:prediction))
  end
